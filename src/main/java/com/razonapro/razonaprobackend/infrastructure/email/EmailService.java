...
public class EmailService {
    ...
    @Async
    public void sendVerificationEmail(String toEmail, String studentName, String rawToken) {
        ...
        String html = """
            <div style="font-family:Arial,sans-serif;max-width:600px;margin:auto;padding:32px">
              ...
              <a href="%s" style="display:inline-block;background:#4F46E5;color:#fff;
                 padding:14px 28px;border-radius:8px;text-decoration:none;font-weight:bold;margin:16px 0">
                Verificar mi correo
              </a>
    ...
    public void sendPasswordResetEmail(String toEmail, String name, String rawToken) {
        ...
        String html = """
            <div style="font-family:Arial,sans-serif;max-width:600px;margin:auto;padding:32px">
              ...
              <p style="color:#888;font-size:13px">Expira en 15 minutos. Si no lo solicitaste, ignora este correo.</p>
            </div>
            """.formatted(name, link);
